...
public class WikiDoclet extends Doclet {
    ...
    public static boolean start(final RootDoc root) {
        ...
        final String wikiURL = "http://wiki.opennms.eu/";
        
        final String wikiUsername = "OpenNMS DocGen";
        final String wikiPassword = "Sz5MqkaGvv/B";
        
        final String wikiNamespace = "Spec";
        ...
        for (final Inspector inspector : inspectors) {
            ...
            // Find the base class
            final ClassDoc baseClass = root.classNamed(inspector.getBaseClassName());
            if (baseClass == null) {
            ...
            for (final ClassDoc clazz : root.classes()) {
                ...
                context.put("doclet", WikiDoclet.class);
                context.put("inspector", inspector);
                ...
                try (final StringWriter buffer = new StringWriter()) {
                    ...
                    logError("Failed to render template: {}", ex.getMessage());
                }
            }
        }
    ...
    public static void logDebug(String message, Object... arguments) {
        WikiDoclet.root.printNotice(MessageFormatter.arrayFormat(message, arguments).getMessage());
    }

    public static void logWarning(String message, Object... arguments) {
        WikiDoclet.root.printWarning(MessageFormatter.arrayFormat(message, arguments).getMessage());
    }

    public static void logError(String message, Object... arguments) {
        WikiDoclet.root.printError(MessageFormatter.arrayFormat(message, arguments).getMessage());
    }
